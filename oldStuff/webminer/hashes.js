        ...
        SHA1:function(r){
            ...
            this.hex=function(r){
                return function(r,n){
                    ...
                    t=r.charCodeAt(f),o+=e.charAt(t>>>4&15)+e.charAt(15&t);
                    return o}
                    ((r=r,function(r){
                        ...
                        (function(r,n){
                            ...
                            {for(f=C,u=g,a=d,h=l,i=A,e=0;e<80;e+=1)c[e]=e<16?r[t+e]:p(c[e-3]^c[e-8]^c[e-14]^c[e-16],1),o=v(v(p(C,5),
                                function(r,n,t,e){
                                    if(r<20)
                                    return n&t|~n&e;
                                    if(r<40)
                                    return n^t^e;
                                    if(r<60)return n&t|n&e|t&e;return n^t^e
                                }(e,g,d,l)),v(v(A,c[e]),function(r){
                                    return r<20?1518500249:r<40?1859775393:r<60?-1894007588:-899497514
                                }(e))),A=l,l=d,d=p(g,30),g=C,C=o;
                                C=v(C,f),g=v(g,u),d=v(d,a),l=v(l,h),A=v(A,i)
                            }return Array(C,g,d,l,A)}(function(r){for(var n=8*r.length,t=Array(r.length>>2),e=t.length,o=0;o<e;o+=1)t[o]=0;
                                for(o=0;o<n;o+=8)t[o>>5]|=(255&r.charCodeAt(o/8))<<24-o%32;
                                return t}(r=t?function(r){var n,t,e,o="",f=-1;
                                ...
                                return o}(r):r),8*r.length))),n)}}},Hashes=r}();